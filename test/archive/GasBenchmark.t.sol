...
contract GasBenchmarkTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory publisherRegistryInitData =
            abi.encodeCall(FlywheelPublisherRegistry.initialize, (owner, address(0)));

        ERC1967Proxy publisherRegistryProxy =
            new ERC1967Proxy(address(publisherRegistryImplementation), publisherRegistryInitData);
        ...
        publisherRegistry.registerPublisherCustom(
            publisher1RefCode, publisherOwner, "https://example.com", publisher1Address, overridePayouts
        );
        publisherRegistry.registerPublisherCustom(
            publisher2RefCode, publisherOwner, "https://example.com", publisher2Address, overridePayouts
        );
        publisherRegistry.registerPublisherCustom(
            publisher3RefCode, publisherOwner, "https://example.com", publisher3Address, overridePayouts
        );
        ...
        FlywheelCampaigns.ConversionConfigInput[] memory conversionEvents =
            new FlywheelCampaigns.ConversionConfigInput[](2);
        ...
        (campaignId, campaignBalanceAddress,) = fwCampaigns.createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl, conversionEvents, emptyPubAllowlist
        );
