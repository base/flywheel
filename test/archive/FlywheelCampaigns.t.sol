...
contract FlywheelCampaignsTest is Test {
    ...
    function setUp() public {
        ...
        (autoGeneratedRefCode1,) =
            publisherRegistry.registerPublisher("https://example.com", autoGeneratedAddress1, overridePayouts);

        (autoGeneratedRefCode2,) =
            publisherRegistry.registerPublisher("https://example.com", autoGeneratedAddress2, overridePayouts);
        ...
        (address _campaignBalanceAddress, uint256 _campaignId) =
            _createAndFundCampaign(address(dummyToken), spdApId, totalFunded1, true);
    ...
    function test_getBasicConversionEvent() public view {
        ...
        IFlywheelCampaigns.ConversionConfig memory conversionConfig =
            fwCampaigns.getConversionConfig(campaignId1, conversionConfigId);
        ...
        IFlywheelCampaigns.ConversionConfig memory conversionConfig2 =
            fwCampaigns.getConversionConfig(campaignId1, conversionConfigId2);
    ...
    function test_createCampaign_tokenAddressNotSupported() public {
        ...
        IFlywheelCampaigns.ConversionConfigInput[] memory conversionEvents =
            new IFlywheelCampaigns.ConversionConfigInput[](1);
        ...
        fwCampaigns.createCampaign(
            tokenAddress, spdApId, true, campaignMetadataUrl1, conversionEvents, emptyPubAllowlist1
        );
    ...
    function test_conversionEvents() public {
        ...
        IFlywheelCampaigns.ConversionConfig memory conversionConfig =
            fwCampaigns.getConversionConfig(campaignId, createdConversionEventId);
    ...
    function test_conversionEventIds() public {
        address tokenAddress = address(dummyToken);
        IFlywheelCampaigns.ConversionConfigInput[] memory conversionEvents =
            new IFlywheelCampaigns.ConversionConfigInput[](2);
        conversionEvents[0] = IFlywheelCampaigns.ConversionConfigInput({
            eventType: IFlywheelCampaigns.EventType.OFFCHAIN,
            eventName: "click",
            conversionMetadataUrl: "https://example.com",
    ...
    function test_addConversionEvent() public {
        ...
        IFlywheelCampaigns.ConversionConfig memory addedEvent =
            fwCampaigns.getConversionConfig(campaignId1, updatedConversionEventCount);
    ...
    function test_deactivateConversionConfig() public {
        ...
        IFlywheelCampaigns.ConversionConfig memory initialEvent =
            fwCampaigns.getConversionConfig(campaignId1, conversionEventId);
        ...
        IFlywheelCampaigns.ConversionConfig memory updatedEvent =
            fwCampaigns.getConversionConfig(campaignId1, conversionEventId);
    ...
    function test_withdrawRemainingBalance_MultipleTimes() public {
        ...
        assertEq(
            balanceAfterSecondWithdraw, balanceAfterFirstWithdraw, "Balance should not change after second withdrawal"
        );
    }
    ...
    function test_withdrawComplexScenario2() public {
        ...
        assertEq(
            dummyToken.balanceOf(recipient), initialBalance123 + 819 ether, "Recipient should receive remaining balance"
        );
    }
    ...
    function testFuzz_claimRewardsRecipientType2(uint256 amount, address recipient, address to) public {
        ...
        assertEq(
            fwCampaigns.getRecipientClaimed(campaignId1, recipient), 0, "Recipient claimed should be 0 before claim"
        );
        ...
        assertEq(
            dummyToken.balanceOf(to) - preClaimBalance, amount, "To address should receive exact attributed amount"
        );
        assertEq(
            dummyToken.balanceOf(campaignBalanceAddress1),
        ...
        assertEq(
            fwCampaigns.getRecipientBalance(campaignId1, recipient), 0, "Recipient balance should be 0 after claim"
        );
        assertEq(
        ...
        fwCampaigns.claimRewards(campaignIds, to);
        assertEq(
            dummyToken.balanceOf(to), balanceBeforeSecondClaim, "Balance should not change on second claim attempt"
        );
        vm.stopPrank();
    }
    ...
    function _runFullFlowTest(
        ...
        (address _campaignBalanceAddress, uint256 _campaignId) =
            _createAndFundCampaign(tokenAddress, spdApId, totalFunded1, true);
        ...
        _performAttributions(
            _campaignId, tokenAddress, attributeAmount1, attributeAmount2, offchainAmount3, onchainAmount3
        );
        ...
        assertEq(
            fwCampaigns.getRecipientBalance(_campaignId, recipient1), 0, "Recipient1 balance should be 0 after claim"
        );
        assertEq(
            fwCampaigns.getRecipientBalance(_campaignId, recipient2), 0, "Recipient2 balance should be 0 after claim"
        );
        assertEq(
        ...
        uint256 remainingBalance =
            initialCampaignBalance - (attributeAmount1 + attributeAmount2 + offchainAmount3 + onchainAmount3);
        ...
        // Verify final campaign state
        (status,,,,,,, totalAmountClaimed, totalAmountAllocated, protocolFeesBalance, isAllowlistSet) =
            fwCampaigns.campaigns(_campaignId);
        ...
        assertEq(
            getBalance(recipient1, tokenAddress) + getBalance(recipient2, tokenAddress)
    ...
    function testFuzz_pushRewards_both_token_types(
        ...
        if (!useNativeToken) {
            _runPushRewardsTest(
                amounts, recipients, registryAmounts, refCodes, address(dummyToken), useAttributionProvider
            );
        } else {
    ...
    function _runPushRewardsTest(
        ...
        IFlywheelCampaigns.OffchainEvent[] memory registryEvents =
            new IFlywheelCampaigns.OffchainEvent[](registryAmounts.length);
        for (uint256 i = 0; i < registryAmounts.length; i++) {
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            ...
            assertEq(
                getBalance(recipients[i], tokenAddress), expectedBalance, "Balance should not change on second push"
            );
        }
    ...
    function testFuzz_protocolFeeAttributionAndWithdraw(uint16 fee, uint256 attributionAmount) public {
        ...
        // Verify accumulated protocol fees
        assertEq(
            fwCampaigns.getAvailableProtocolFees(campaignId1), totalExpectedFee, "Accumulated protocol fees incorrect"
        );
    ...
    function test_createCampaignWithAllowlist() public {
        ...
        (uint256 campaignId, address campaignBalanceAddress, uint8[] memory conversionEventIds) = fwCampaigns
            .createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl1, dummyConversionEvents1, allowedRefCodes
        );
    ...
    function test_addAllowedPublisherRefCode_failsWhenAllowlistNotSet() public {
        ...
        (uint256 campaignId, address campaignBalanceAddress, uint8[] memory conversionEventIds) = fwCampaigns
            .createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl1, dummyConversionEvents1, emptyAllowlist
        );
    ...
    function test_addAllowedPublisherRefCode_success() public {
        ...
        vm.prank(owner);
        publisherRegistry.registerPublisherCustom(
            "newPublisher", publisherOwner, "https://example.com", newPublisherAddress, overridePayouts
        );
    ...
    function test_createCampaignWithInvalidRefCodes() public {
        ...
        fwCampaigns.createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl1, dummyConversionEvents1, invalidRefCodes
        );
        vm.stopPrank();
        ...
        vm.expectRevert(IFlywheelCampaigns.InvalidPublisherRefCode.selector);
        fwCampaigns.createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl1, dummyConversionEvents1, mixedRefCodes
        );
        vm.stopPrank();
    ...
    function test_addAllowedPublisherRefCode_invalidPublisher() public {
        ...
        assertTrue(
            fwCampaigns.isPublisherRefCodeAllowed(campaignId, publisher1RefCode), "Publisher1 should still be allowed"
        );
        assertTrue(
            fwCampaigns.isPublisherRefCodeAllowed(campaignId, publisher2RefCode), "Publisher2 should still be allowed"
        );
        assertFalse(
    ...
    function test_e2e_noRegistry_offchainAndOnchainAttributions() public {
        ...
        (uint256 campaignId, address campaignBalanceAddress, uint8[] memory conversionEventIds) = fwCampaignsNoRegistry
            .createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl1, dummyConversionEvents1, emptyPubAllowlist1
        );
    ...
    function test_e2e_noRegistry_mixedRecipientTypes() public {
        ...
        // Verify campaign totals
        (,,,,,,, uint256 totalAmountClaimed, uint256 totalAmountAllocated,,) =
            fwCampaignsNoRegistry.campaigns(campaignId);
        assertEq(totalAmountClaimed, amount * 3, "Total claimed should equal sum of all claims");
        assertEq(totalAmountAllocated, amount * 3, "Total attributed should equal sum of all attributions");
    }
    ...
    function test_createCampaignWithAllowlist_noRegistry() public {
        ...
        assertEq(
            fwCampaignsNoRegistry.getRecipientBalance(campaignId, payoutAddress1), 0, "Balance should be 0 after claim"
        );
        vm.stopPrank();
    }
    ...
    function test_addAllowedPublisherRefCode_alreadyAllowed() public {
        ...
        assertTrue(
            fwCampaigns.isPublisherRefCodeAllowed(campaignId, publisher1RefCode), "Publisher ref code should be allowed"
        );
    ...
    function test_createCampaign_maxConversionConfigsReached() public {
        ...
        IFlywheelCampaigns.ConversionConfigInput[] memory tooManyConfigs =
            new IFlywheelCampaigns.ConversionConfigInput[](256);
        ...
        fwCampaigns.createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl1, tooManyConfigs, emptyPubAllowlist1
        );
        vm.stopPrank();
    }
    ...
    function test_getPublisherPayoutAddress() public {
        ...
        assertEq(
            payoutAddress3, autoGeneratedAddress1, "Should return correct payout address for auto-generated publisher"
        );
    }
