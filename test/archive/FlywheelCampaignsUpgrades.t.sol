...
contract FlywheelCampaignsUpgradesTest is Test {
    ...
    function setUp() public {
        ...
        FlywheelCampaigns.ConversionConfigInput[] memory conversionConfigs =
            new FlywheelCampaigns.ConversionConfigInput[](1);
        ...
        (campaignId1,,) = fwCampaigns.createCampaign(
            address(dummyToken), spdApId, true, campaignMetadataUrl1, conversionConfigs, emptyPubAllowlist1
        );
    ...
    function test_basic_upgrade() public {
        ...
        FlywheelPublisherRegistryV2 publisherRegistryV2Instance =
            FlywheelPublisherRegistryV2(address(publisherRegistry));
        ...
        assertEq(
            address(publisherRegistry), originalPublisherRegistry, "Publisher registry proxy address should not change"
        );
