...
contract FlywheelSecurityTest is FlywheelTestHelpers {
    ...
    function setUp() public {
        ...
        // Deploy test hook
        testHook = new AdvertisementConversion(
            address(flywheel),
            OWNER,
    ...
    function test_security_nestedReentrancy() public {
        ...
        NestedReentrancyAttacker nestedAttacker = new NestedReentrancyAttacker(
            address(flywheel),
            campaign,
            address(token)
        );
    ...
    function test_security_roleImpersonation() public {
        ...
        RoleImpersonationAttacker roleAttacker = new RoleImpersonationAttacker(
            address(flywheel),
    ...
    function test_security_frontRunningAttacks() public {
        ...
        FrontRunningAttacker frontRunner = new FrontRunningAttacker(
            address(flywheel),
            campaign,
            address(token)
        );
    ...
    function test_security_campaignSpamAttacks() public {
        CampaignSpamAttacker spamAttacker = new CampaignSpamAttacker(
            address(flywheel),
            address(testHook)
        );
    ...
    function _createTestCampaign() internal returns (address) {
        return flywheel.createCampaign(address(testHook), 1, abi.encode(
            ATTRIBUTION_PROVIDER,
            ADVERTISER,
            "test-uri-1",
            new string[](0),
