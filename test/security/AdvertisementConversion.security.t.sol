...
contract AdvertisementConversionSecurityTest is AdvertisementConversionTestHelpers {
    ...
    function test_security_crossFunctionReentrancy() public {
        ...
        CrossFunctionReentrancyAttacker crossAttacker = new CrossFunctionReentrancyAttacker(
            address(hook), 
            campaign
        );
    ...
    function test_security_privilegeEscalation() public {
        ...
        PrivilegeEscalationAttacker escalationAttacker = new PrivilegeEscalationAttacker(
            address(hook),
    ...
    function test_security_malformedDataAttacks() public {
        ...
        (Flywheel.Payout[] memory payouts, uint256 fee) = hook.onReward(ATTRIBUTION_PROVIDER, campaign, address(token), emptyData);
    ...
    function test_security_boundaryConditionAttacks() public {
        ...
        AdvertisementConversion.Attribution[] memory boundaryAttacks = 
    ...
    function test_security_allowlistBypass() public {
        ...
        _registerPublisher("ALLOWED_REF", address(0x1001), "https://allowed.com", address(0x1001));
        
        AllowlistBypassAttacker bypassAttacker = new AllowlistBypassAttacker(
            address(hook),
            allowlistCampaign
        );
