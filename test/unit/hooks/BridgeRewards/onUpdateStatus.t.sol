...
contract OnUpdateStatusTest is BridgeRewardsTest {
    ...
    function test_onUpdateStatus_revert_nonActiveStatus(uint8 statusValue) public {
    ...
    function test_onUpdateStatus_success_toActiveStatus(uint8 statusValue) public {
