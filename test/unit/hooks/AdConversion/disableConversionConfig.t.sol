...
abstract contract DisableConversionConfigTest is AdConversionTestBase {
    // ========================================
    // REVERT CASES
    // ========================================
    ...
    function test_revert_unauthorizedCaller(address unauthorizedCaller, address campaign, uint16 configId)
        public
        virtual;
    ...
    function test_revert_configDoesNotExist(address advertiser, address campaign, uint16 nonExistentConfigId)
        public
        virtual;
    ...
    /// @param advertiser Advertiser address
    /// @param campaign Campaign address
    function test_revert_configIdZero(address advertiser, address campaign) public virtual;
    ...
    function test_revert_configAlreadyInactive(address advertiser, address campaign, uint16 inactiveConfigId)
        public
        virtual;
    ...
    function test_success_disableActiveConfig(address advertiser, address campaign, uint16 activeConfigId)
        public
        virtual;
    ...
    function test_success_disableOnchainConfig(address advertiser, address campaign, uint16 onchainConfigId)
        public
        virtual;
    ...
    function test_success_disableOffchainConfig(address advertiser, address campaign, uint16 offchainConfigId)
        public
        virtual;
    ...
    function test_edge_maximumConfigId(address advertiser, address campaign, uint16 maxConfigId) public virtual;
    ...
    function test_edge_nonSequentialDisabling(address advertiser, address campaign, uint16[] memory configIds)
        public
        virtual;
    ...
    function test_edge_disableAllConfigs(address advertiser, address campaign, uint16[] memory allConfigIds)
        public
        virtual;
    ...
    function test_emitsConversionConfigStatusChanged(address advertiser, address campaign, uint16 configId)
        public
        virtual;
    ...
    /// @param campaign Campaign address
    /// @param configId Active conversion config ID to disable
    function test_updatesConfigStatus(address advertiser, address campaign, uint16 configId) public virtual;

    /// @dev Verifies config data remains unchanged except status
    /// @param advertiser Advertiser address
    /// @param campaign Campaign address
    /// @param configId Active conversion config ID to disable
    function test_preservesConfigData(address advertiser, address campaign, uint16 configId) public virtual;

    /// @dev Verifies config count remains unchanged
    /// @param advertiser Advertiser address
    /// @param campaign Campaign address
    /// @param configId Active conversion config ID to disable
    function test_preservesConfigCount(address advertiser, address campaign, uint16 configId) public virtual;
    ...
    function test_notIdempotent(address advertiser, address campaign, uint16 configId) public virtual;
    ...
    /// @param allConfigIds All config IDs in campaign
    function test_campaignStillFunctional(address advertiser, address campaign, uint16[] memory allConfigIds)
        public
        virtual;
}
