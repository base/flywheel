...
contract DeallocateTest is Test {
    ...
    function test_deallocate_reverts_whenCampaignDoesNotExist(address token, bytes memory hookData) public {}
    ...
    function test_deallocate_reverts_ifCampaignIsInsufficientlyFunded(uint256 amount) public {}

    /// @dev Verifies that deallocate calls are allowed for campaign in ACTIVE state
    /// @param amount Deallocation amount
    function test_deallocate_succeeds_whenCampaignActive(uint256 amount) public {}
    ...
    /// @param amount Deallocation amount
    function test_deallocate_succeeds_withERC20Token(uint256 amount) public {}

    /// @dev Verifies that deallocate calls work with native token
    /// @param amount Deallocation amount
    function test_deallocate_succeeds_withNativeToken(uint256 amount) public {}
    ...
    function test_deallocate_ignoresZeroAmountDeallocations() public {}
    ...
    function test_deallocate_succeeds_withMultipleDeallocations(uint256 amount1, uint256 amount2) public {}

    /// @dev Verifies that the PayoutsDeallocated event is emitted for each deallocation
    /// @param amount Deallocation amount
    function test_deallocate_emitsPayoutsDeallocatedEvent(uint256 amount) public {}
}
